...
const VECTOR_STORE_PATH = "ragasVectorDB.index";
// const question = "Tell me about these docs";
const question = `Generate a text to music prompt for single romantic raga, include several relevant parameters such as tempo, scale, pitch, rhythm, dynamics, texture, timbre, etc. for an optimized romantic mood. Specify suitable alues for each of these features from your knowledge and include in the prompt generated. Make it in 50-100 words. This prompt is given as a prompt to ai music generator musicgen.`;
// "Generate me an array of ragas to listen to when I am romantic,Only include the raga type and no other details inside an array.";

// const prompt = `Generate a text to music prompt for romantic ragas, include several relevant paramters such as tempo for an optimized romantic mood.`;
