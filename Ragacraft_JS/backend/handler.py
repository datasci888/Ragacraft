...
# openai.api_key = "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"
...
#     # API key
#     api_key = "dcbd7f788abfb5daee20f3977d106445"
...
def suggest_raga(feeling):
    if "happy" in feeling.lower():
        return "Happy Raga"
    elif "sad" in feeling.lower():
        return "Sad Raga"
    else:
        return "Neutral Raga"

def generate_prompt(raga_type, tempo_preference):
    return f"Generate a musical prompt in {raga_type} with a {tempo_preference} tempo."
