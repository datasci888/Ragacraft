      ...
      endpoints: [
        {
          name: "api",
          endpoint:
            "https://ak95dt0vlf.execute-api.us-east-1.amazonaws.com/dev",
        },
      ],
    },
  });
...
function App() {
  ...
  {
    role: 'assistant',
    content: 'Based on your feeling, I suggest trying the Happy Raga.',
    text: 'Based on your feeling, I suggest trying the Happy Raga.'
  },
  {
    role: 'user',
    content: 'I prefer a fast tempo.',
    text: 'I prefer a fast tempo.'
  },
  {
    role: 'assistant',
    content: 'You\'ve selected Happy Raga with a fast tempo. Should I proceed to generate a prompt? (yes/no)',
    text: 'You\'ve selected Happy Raga with a fast tempo. Should I proceed to generate a prompt? (yes/no)'
  },
  ];
  ...
  const ChatHeader = () => {
    return (
      <Typography variant="h4" align="center" gutterBottom>
        AudioCraft Hackathon Raga Chatbot
      </Typography>
    );
  };
